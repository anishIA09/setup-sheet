  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <button className="h-9 gap-2 text-sm font-semibold rounded-md bg-primary text-primary-foreground px-3 py-2 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {STATS.map((stat) => {
          return (
            <div
              key={stat.label}
              className="p-4 rounded-md bg-card text-card-foreground flex items-center justify-between shadow-md font-semibold gap-3"
            >
